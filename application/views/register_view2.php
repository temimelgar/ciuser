                            ...
                            <table class="table table-striped table-hover" id="tbl_data" style="white-space: nowrap">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td  class="edit_details" data-id="<?php echo $id; ?>" data-fullname="<?php echo $fullname; ?>" data-provincename="<?php echo $provDesc; ?>" data-province="<?php echo $province; ?>" data-username="<?php echo $username; ?>" data-address="<?php echo $address; ?>" data-contact="<?php echo $contact; ?>" data-position="<?php echo $position; ?>" data-password ="<?php echo $password; ?>" data-department="<?php echo $department; ?>"  data-date_hired="<?php echo $date_hired; ?>" data-date-format="dd-mm-yyyy" data-address="<?php echo $address; ?>" data-contact="<? echo $contact; ?>"><a data-toggle="modal"  class="btn btn-danger" data-target="#editModal" ><i class="fa fa-edit" data-toggle="tooltip" data-placement="top" title="Edit"></i></a></td>
                ...
                <form method="POST">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                           <div class="form-group">
                                <span>Province: </span>
                                    <select class="form-control" id="updateProvince">
                                        <option>Please choose...</option>
...
// $('#updateDate_hired').datetimepicker();
    $('.edit_details').click(function() {
        ...
        // $("#updateProvince > [value='"+provDesc+"']").attr("selected", true);
        // alert(province);
        // $("#updateProvince > [value='CAV']").attr("selected", "true");
